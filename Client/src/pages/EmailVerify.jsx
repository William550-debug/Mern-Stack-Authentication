...
const EmailVerify = () => {
  ...
  console.log('Current refs:', inputRefs.current)
...
useEffect(() => {
  ...
  // If logged in but not verified, stay on page
...
const onSubmitHandler = async (e) =>{
  ...
  return (   
    <div className='flex items-center justify-center min-h-screen px-6 sm:px-0 bg-gradient-to-br from-blue-200 to bg-purple-400'>
      <img 
            onClick={()=> navigate('/')}
            src={assets.logo} alt=""  className='absolute left-5 sm:left-30 top-5 w-28 sm:w-32 cursor-pointer'/>
